...
public class ListarSolicitud extends JDialog {
    ...
    public ListarSolicitud() {
        ...
        String[] columnas = {"ID", "Tipo Trabajo", "Título / Habilidad", "Provincia", "Exp.", "Licencia", "Rango Salario", "Estado"};
                ...
                if (respuesta == JOptionPane.YES_OPTION) {
                    ...
                    if (solicitud != null) {
                        ...
                        JOptionPane.showMessageDialog(ListarSolicitud.this,
                                "La Solicitud ha sido desactivada correctamente.", "Éxito",
        ...
        if (lista != null) {
            for (Solicitud s : lista) {
                ...
                Object[] fila = {
                    ...
                    tituloOHabilidad,
                    s.getProvincia(),
                    s.getExperienciaLaboral() + " años",
                    s.isLicenciaDeConducir() ? "Sí" : "No",
                    rangoSalario,
                    estado
                };
