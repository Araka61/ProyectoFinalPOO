...
public class RegistrarSolicitud extends JDialog {
    ...
    public RegistrarSolicitud(Window parent, String idSolicitud) {
        ...
        lblTitulo.setBounds(290, 15, 240, 16);
        ...
        txtTiempoTrabajo.setForeground(colorTexto);
        txtTiempoTrabajo.setBackground(bgInputs);
        txtTiempoTrabajo.setBounds(115, 45, 160, 22);
        contentPanel.add(txtTiempoTrabajo);

        JLabel lblExperiencia = new JLabel("Exp. (Años):");
        lblExperiencia.setForeground(colorTexto);
        ...
        lblSalMin.setForeground(colorTexto);
        ...
        lblSalMax.setForeground(colorTexto);
        ...
        chkMudarse.setForeground(colorTexto);
        chkMudarse.setBackground(bgPrincipal);
        chkMudarse.setBounds(12, 145, 250, 23);
        ...
        okButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (tipo.isEmpty() || tiempoTrabajo.isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Por favor complete los campos requeridos (Tipo, Disponibilidad).", "Campo requerido", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ...
                String tituloCarrera = "n/a", diplomaTecnico = "n/a", habilidadOficio = "n/a";
                if (persona instanceof Grado) tituloCarrera = ((Grado) persona).getCarrera();
                else if (persona instanceof Tecnico) diplomaTecnico = ((Tecnico) persona).getDiplomaTecnico();
                else if (persona instanceof Trabajador) habilidadOficio = ((Trabajador) persona).getOficio();

                if (idSolicitud != null) {
                    Solicitud sol = BolsaEmpleo.getInstancia().buscarSolicitud(idSolicitud);
                    if(sol != null) {
                    ...
                    BolsaEmpleo.getInstancia().registrarSolicitud(usuario.getId(), tipo, 
